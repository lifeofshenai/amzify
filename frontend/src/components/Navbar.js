...
const Navbar = () => {
  ...
  return (
    <nav
      className={`navbar sticky top-4 z-40 flex justify-stretch items-center mt-2 w-full bg-base-100 rounded-xl bg-white/10 p-2 backdrop-blur-xl dark:bg-[#0b14374d]`}
    >
      {/* Main Navbar Content */}
      <div className="relative mt-[3px] h-[65px] flex flex-grow items-center justify-around gap-2  rounded-full bg-white px-2 py-2 shadow-xl shadow-shadow-500 dark:!bg-navy-800 dark:shadow-none md:w-[1080px] md:flex-grow-0 md:gap-1 xl:w-[1080px] xl:gap-2">
